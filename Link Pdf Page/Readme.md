...
Step 1) Set up the Path for Acrobat Reader
	...
	b) Paste the path in Settings.ini
		eg.
		[LOCATION]
		acrobat_location=C:\Program Files (x86)\Adobe\Acrobat Reader DC\Reader\AcroRd32.exe
Step 2) Set up Pdfs
	a) Paste the Pdf files in the Pdfs folder
...
Step 3) Give the reference commands in the mindmap
	...
	b) Give as many references you would like 
Step 4) Run the Exe
	a) Keep the Mindmap file in the same folder as the exe file
	b) Run the exe
Step 5) Close the file and open again to see the effect.
